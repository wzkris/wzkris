...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统服务', 0, 100, 'system', NULL, '', 'M', '0', '', 'system', 0, 0, 1, 1713334134616, 1, 1719220271159, 1);
INSERT INTO `sys_menu` VALUES (2, '用户及权限服务', 0, 99, 'ur', NULL, '', 'M', '0', '', 'peoples', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (3, '租户管理', 0, 50, 'tenant', NULL, '', 'M', '0', '', 'monitor', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (4, '设备管理', 0, 10, 'equipment', NULL, NULL, 'M', '0', '', 'icon', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (5, '订单服务', 0, 4, 'order', NULL, NULL, 'M', '0', '', 'money', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (100, '通知公告', 1, 15, 'notice', 'system/notice/index', '', 'C', '0', 'notice:list', 'guide', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (101, '控制台入口', 1, 0, 'controller', NULL, NULL, 'M', '0', '', 'message', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
...
INSERT INTO `sys_menu` VALUES (203, '后台管理', 2, 100, 'user', 'ur/user/index', NULL, 'C', '0', 'sys_user:list', 'people', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (205, '部门管理', 2, 70, 'dept', 'ur/dept/index', '', 'C', '0', 'dept:list', 'tree', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
...
INSERT INTO `sys_menu` VALUES (1003, '用户删除', 201, 4, '', '', '', 'F', '0', 'customer:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1004, '用户导出', 201, 5, '', '', '', 'F', '0', 'customer:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1006, '重置密码', 203, 7, '', '', '', 'F', '0', 'sys_user:resetPwd', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (1007, '角色查询', 206, 1, '', '', '', 'F', '0', 'sys_role:query', '#', 0, 0, 1, 1713334134616, 1, 1719217877512, 1);
INSERT INTO `sys_menu` VALUES (1008, '角色新增', 206, 2, '', '', '', 'F', '0', 'sys_role:add', '#', 0, 0, 1, 1713334134616, 1, 1719217874128, 1);
INSERT INTO `sys_menu` VALUES (1009, '角色修改', 206, 3, '', '', '', 'F', '0', 'sys_role:edit', '#', 0, 0, 1, 1713334134616, 1, 1719217870573, 1);
INSERT INTO `sys_menu` VALUES (1010, '角色删除', 206, 4, '', '', '', 'F', '0', 'sys_role:remove', '#', 0, 0, 1, 1713334134616, 1, 1719217866461, 1);
INSERT INTO `sys_menu` VALUES (1011, '角色导出', 206, 5, '', '', '', 'F', '0', 'sys_role:export', '#', 0, 0, 1, 1713334134616, 1, 1719217862943, 1);
INSERT INTO `sys_menu` VALUES (1012, '菜单查询', 207, 1, '', '', '', 'F', '0', 'menu:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1013, '菜单新增', 207, 2, '', '', '', 'F', '0', 'menu:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1014, '菜单修改', 207, 3, '', '', '', 'F', '0', 'menu:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1015, '菜单删除', 207, 4, '', '', '', 'F', '0', 'menu:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1016, '部门查询', 205, 1, '', '', '', 'F', '0', 'dept:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1017, '部门新增', 205, 2, '', '', '', 'F', '0', 'dept:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1018, '部门修改', 205, 3, '', '', '', 'F', '0', 'dept:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1019, '部门删除', 205, 4, '', '', '', 'F', '0', 'dept:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1020, '岗位查询', 208, 1, '', '', '', 'F', '0', 'post:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1021, '岗位新增', 208, 2, '', '', '', 'F', '0', 'post:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1022, '岗位修改', 208, 3, '', '', '', 'F', '0', 'post:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1023, '岗位删除', 208, 4, '', '', '', 'F', '0', 'post:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1024, '岗位导出', 208, 5, '', '', '', 'F', '0', 'post:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1025, '字典查询', 102, 1, '#', '', '', 'F', '0', 'dict:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1026, '字典新增', 102, 2, '#', '', '', 'F', '0', 'dict:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1027, '字典修改', 102, 3, '#', '', '', 'F', '0', 'dict:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1028, '字典删除', 102, 4, '#', '', '', 'F', '0', 'dict:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1029, '字典导出', 102, 5, '#', '', '', 'F', '0', 'dict:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1030, '参数查询', 103, 1, '#', '', '', 'F', '0', 'config:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1031, '参数新增', 103, 2, '#', '', '', 'F', '0', 'config:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1032, '参数修改', 103, 3, '#', '', '', 'F', '0', 'config:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1033, '参数删除', 103, 4, '#', '', '', 'F', '0', 'config:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1034, '参数导出', 103, 5, '#', '', '', 'F', '0', 'config:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1035, '公告查询', 100, 1, '#', '', '', 'F', '0', 'message:notice:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1036, '公告新增', 100, 2, '#', '', '', 'F', '0', 'message:notice:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1037, '公告修改', 100, 3, '#', '', '', 'F', '0', 'message:notice:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1038, '公告删除', 100, 4, '#', '', '', 'F', '0', 'message:notice:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1039, '操作查询', 150, 1, '#', '', '', 'F', '0', 'operlog:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1040, '操作删除', 150, 2, '#', '', '', 'F', '0', 'operlog:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1041, '日志导出', 150, 3, '#', '', '', 'F', '0', 'operlog:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
...
INSERT INTO `sys_menu` VALUES (1076, '用户导出', 203, 1, '', '', NULL, 'F', '0', 'sys_user:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (1077, '用户删除', 203, 8, NULL, NULL, NULL, 'F', '0', 'sys_user:remove', NULL, 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
INSERT INTO `sys_menu` VALUES (1081, '交易查询', 500, 0, '', NULL, NULL, 'F', '0', 'order:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1083, '优惠券查询', 501, 0, '', NULL, NULL, 'F', '0', 'coupon:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1084, '优惠券编辑', 501, 1, '', NULL, NULL, 'F', '0', 'coupon:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1085, '优惠券添加', 501, 1, '', NULL, NULL, 'F', '0', 'coupon:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1086, '优惠券删除', 501, 2, '', NULL, NULL, 'F', '0', 'coupon:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1087, '交易删除', 500, 2, '', NULL, NULL, 'F', '0', 'order:remove', '#', 0, 0, 0, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1089, '角色权限', 206, 6, '', NULL, NULL, 'F', '0', 'sys_role:auth', '#', 0, 0, 0, 1713334134616, 1, 1719217859646, 1);
INSERT INTO `sys_menu` VALUES (1091, '等级查询', 202, 0, '', NULL, NULL, 'F', '0', 'level:query', '#', 0, 0, 0, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1092, '等级修改', 202, 1, '', NULL, NULL, 'F', '0', 'level:edit', '#', 0, 0, 0, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1093, '等级添加', 202, 2, '', NULL, NULL, 'F', '0', 'level:add', '#', 0, 0, 0, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1094, '等级删除', 202, 3, '', NULL, NULL, 'F', '0', 'level:remove', '#', 0, 0, 0, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1100, '站点查询', 400, 0, NULL, NULL, NULL, 'F', '0', 'station:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1101, '站点添加', 400, 1, NULL, NULL, NULL, 'F', '0', 'station:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1102, '站点修改', 400, 2, NULL, NULL, NULL, 'F', '0', 'station:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1103, '站点删除', 400, 3, NULL, NULL, NULL, 'F', '0', 'station:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1104, '站点导出', 400, 5, NULL, NULL, NULL, 'F', '0', 'station:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1105, '设备查询', 401, 0, NULL, NULL, NULL, 'F', '0', 'device:query', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1106, '设备添加', 401, 1, NULL, NULL, NULL, 'F', '0', 'device:add', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1107, '设备修改', 401, 2, NULL, NULL, NULL, 'F', '0', 'device:edit', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1108, '设备删除', 401, 3, NULL, NULL, NULL, 'F', '0', 'device:remove', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1109, '设备导出', 401, 4, NULL, NULL, NULL, 'F', '0', 'device:export', '#', 0, 0, 1, 1713334134616, 1, 1714113020581, NULL);
INSERT INTO `sys_menu` VALUES (1110, '租户详情', 600, 9, NULL, NULL, NULL, 'F', '0', 'tenant:query', NULL, 0, 0, 1, 1713334134616, 1, 1714113020581, 1);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 0, 100, 'admin', 'ry@163.com', 'nick_admin', '15888888888', '0', '0', '/uploadPath/2023/06/10/blob_20230610111344A003.png', '{bcrypt}$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 0, '127.0.0.1', 1719989381019, NULL, 1713334134616, 1, NULL, NULL);
