...
-- ----------------------------
INSERT INTO `oauth2_client` VALUES (1, 'inner-client', '{bcrypt}$2a$10$jKXqoIKK.w57jS5MKKasH.NQxxpfyUOlvP9yIXYsXelR7dbUGgBn.', '[\"inner\"]', '[\"client_credentials\"]', '[]', '0', 0, 1713334134616, 1, NULL, NULL);
