...
INSERT INTO `config_info` VALUES (12, 'wzkris-auth.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/auth\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\n# springdoc配置\nspringdoc:\n  title: 认证模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 安全配置\nsecurity:\n  # 不校验白名单\n  ignores:\n    #swagger接口放行\n    - /v3/api-docs/**\n    # 验证码放行\n    - /captcha/**\n    - /authorization_code_callback\n\n# token配置\ntoken-config:\n  accessTokenTimeOut: 1800\n  refreshTokenTimeOut: 86400\n  authorizationCodeTimeOut: 1800\n  deviceCodeTimeOut: 1800\n', '7f26f8a0a7a25ed5472dedd7883741d9', '2023-06-19 02:28:00', '2025-05-21 17:09:04', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (14, 'wzkris-monitor-admin.yml', 'APPLICATION_GROUP', '# spring\nspring:\n  security:\n    user:\n      name: admin\n      password: admin123\n  boot:\n    admin:\n      ui:\n        title: 服务状态监控\n\noauth2-client:\n  url: http://192.168.0.112:9000/oauth2/token\n  clientId: server_monitor\n  clientSecret: secret\n  scopes:\n    - monitor', '3a90f4c7f05b26713bf2d7a1c8bbcd83', '2023-06-19 02:28:00', '2025-05-21 17:22:09', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
