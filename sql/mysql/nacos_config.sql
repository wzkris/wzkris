...
INSERT INTO `config_info` VALUES (12, 'common.yml', 'COMMON_GROUP', 'server:\n  # 优雅停机\n  shutdown: graceful\n  # 服务器配置\n  tomcat:\n    accept-count: 100\n    threads:\n      max: 1000\n      min-spare: 200\n    connection-timeout: 10000\n    # 监控\n    mbeanregistry:\n      enabled: true\n\nspring:\n  task:\n    execution:\n      thread-name-prefix: async-threadPool-\n      pool:\n        core-size: 15\n        max-size: 30\n        queue-capacity: 1000\n        keep-alive: 120s\n        allow-core-thread-timeout: false\n      shutdown:\n        await-termination: true\n        await-termination-period: 60s\n    scheduling:\n      thread-name-prefix: scheduling-threadPool-\n      pool:\n        size: 10\n      shutdown:\n        await-termination: true\n        await-termination-period: 60s\n  jackson:\n    time-zone: GMT+8\n    # 日期格式化\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略空Bean转json的错误\n      FAIL_ON_EMPTY_BEANS: false\n      # 关闭日期转换成时间戳\n      WRITE_DATES_AS_TIMESTAMPS: false\n    # 设置空如何序列化\n    defaultPropertyInclusion: ALWAYS\n    deserialization:\n      #json中不存在的属性就报错\n      fail_on_unknown_properties: false\n    parser:\n      # 允许使用无引号字段\n      ALLOW_UNQUOTED_FIELD_NAMES: true\n      # 忽略未定义的属性\n      IGNORE_UNDEFINED: true\n      # 忽略json最后的逗号\n      ALLOW_TRAILING_COMMA: true\n      # 允许反斜杠\n      ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER: true\n      # 允许出现特殊字符和转义符\n      ALLOW_UNQUOTED_CONTROL_CHARS: true\n      # 允许出现单引号\n      ALLOW_SINGLE_QUOTES: true\n      # 是否允许使用注释\n      ALLOW_COMMENTS: true\n    mapper:\n      # 使用getter取代setter探测属性，如类中含getName()但不包含name属性与setName()，传输的vo json格式模板中依旧含name属性\n      USE_GETTERS_AS_SETTERS: true\n  mvc:\n    # mvc找不到对应处理器则抛出异常\n    throw-exception-if-no-handler-found: true\n    # 关闭DispatcherServlet懒加载\n    servlet:\n      load-on-startup: 0\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common\n\n#分布式事务\nseata:\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      ruoyi-system-group: default\n    # 分组和 Seata 服务的映射\n    grouplist:\n      default: 127.0.0.1:8091\n  config:\n    type: nacos\n    nacos:\n      serverAddr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      group: SEATA_GROUP\n      namespace: application-dev\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      namespace: application-dev\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    env:\n      access: read_only\n      show-values: always\n    configprops:\n      access: read_only\n      show-values: always\n    beans:\n      access: read_only\n\nsignature:\n  keys:\n    wzkris-gateway:\n      secret: my-super-secret-key\n    wzkris-principal:\n      secret: my-super-secret-key-0\n    wzkris-auth:\n      secret: my-super-secret-key-1\n    wzkris-message:\n      secret: my-super-secret-key-2\n    wzkris-monitor-admin:\n      secret: my-super-secret-key-3\n\n# 路由策略\nroute-policy:\n  status: 1\n  defaultHint: \"\"\n  forceHint: 0.1', '36817fdfe5c3967f7d93bb41b32efa8e', '2023-06-19 02:28:00', '2025-12-02 14:48:56', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '公共配置', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (13, 'wzkris-gateway.yml', 'APPLICATION_GROUP', 'spring:\n  cloud:\n    gateway:\n      server:\n        webflux:\n          httpclient:\n            connect-timeout: 5000\n            response-timeout: 5000\n            pool:\n              type: FIXED\n              max-connections: 1000\n              acquire-timeout: 80000\n              max-life-time: 30000\n              max-idle-time: 5000\n          discovery:\n            locator:\n              lower-case-service-id: true\n              enabled: true\n          default-filters: # 全局默认过滤器，对所有路由生效\n            - name: RequestSize\n              args:\n                maxSize: 5MB\n          routes:\n            # 认证中心\n            - id: wzkris-auth\n              uri: lb://wzkris-auth\n              predicates:\n                - Path=/auth-api/**\n              filters:\n                - StripPrefix=1\n                    # 业务主体服务\n            - id: wzkris-principal\n              uri: lb://wzkris-principal\n              predicates:\n                - Path=/prin-api/**\n              filters:\n                - StripPrefix=1\n            # 消息模块\n            - id: wzkris-message\n              uri: lb://wzkris-message\n              predicates:\n                - Path=/msg-api/**\n              filters:\n                - StripPrefix=1\nknife4j:\n  # 聚合swagger文档\n  gateway:\n    enabled: true\n    strategy: discover\n    discover:\n      version: openapi3\n      enabled: true\n      service-config:\n        wzkris-auth:\n          - group-name: 认证服务\n            order: 1\n        wzkris-principal:\n          - group-name: 主体服务\n            order: 1\n        wzkris-message:\n          - group-name: 消息服务\n            order: 2\n    tags-sorter: order\n    operations-sorter: order\n\n# 防止XSS攻击\nxss:\n  enabled: true\n  excludeUrls:\n    - /msg-api/announcement-manage/add\n    - /msg-api/announcement-manage/edit\n\n# 网关放行\nsecurity:\n  ignores:\n    # 验证码放行\n    - /auth-api/captcha/**\n    # 登录接口\n    - /auth-api/login\n    # 登出接口\n    - /auth-api/logout\n    # oauth2接口\n    - /auth-api/oauth2/**\n    # 二维码登录\n    - /auth-api/qr-code\n    - /auth-api/qr-code/poll-status\n    # 回调接口\n    - /auth-api/authorization_code_callback\n    - /prin-api/nacos/**\n    # swagger接口放行\n    - /doc.html\n    - /favicon.ico\n    - /webjars/**\n    - /v3/api-docs/**\n    - /*/v3/api-docs/**\n    # 监控端点\n    - /actuator/**', '5f1aad68037fee8b4a6f7c00996fed0c', '2023-06-19 02:28:00', '2025-11-25 16:28:30', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (14, 'wzkris-auth.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/auth\n\n# springdoc配置\nspringdoc:\n  title: 认证模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 动态线程池\ndynamic-threadpool:\n  tomcatExecutor:\n    maxThreads: 2000\n    minSpareThreads: 500\n    keepAliveTimeout: 60000\n    acceptCount: 100', '8888a45f362497b8c802d1788faad0b9', '2023-06-19 02:28:00', '2025-12-02 15:07:43', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (15, 'wzkris-principal.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/principal\n  # datasource:\n  #   driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n  #   url: jdbc:shardingsphere:classpath:sharding-${spring.profiles.active}.yml\n  datasource:\n    url: jdbc:postgresql://localhost:5432/wzkris_principal?ssl=false&reWriteBatchedInserts=true&stringtype=unspecified\n    username: root\n    password: root\n    driver-class-name: org.postgresql.Driver\n    hikari:\n      connection-timeout: 30000 \n      maximum-pool-size: 10       \n      minimum-idle: 5             \n      idle-timeout: 600000        \n      pool-name: hikari-pool\n\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.wzkris.principal.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/*/*.xml\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n\n# springdoc配置\nspringdoc:\n  title: 用户模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 租户配置\ntenant:\n  includes:\n    - member_info\n    - post_info\n    - tenant_info\n    - tenant_wallet_info\n    - tenant_wallet_record\n    - tenant_wallet_withdrawal_record', 'ca16827866819a495abd02825c208da8', '2024-04-16 06:36:22', '2025-11-13 13:58:33', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (17, 'wzkris-message.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/message\n  # datasource:\n  #   driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n  #   url: jdbc:shardingsphere:classpath:sharding-${spring.profiles.active}.yml\n  datasource:\n    url: jdbc:postgresql://localhost:5432/wzkris_message?ssl=false&reWriteBatchedInserts=true&stringtype=unspecified\n    username: root\n    password: root\n    driver-class-name: org.postgresql.Driver\n    hikari:\n      connection-timeout: 30000 \n      maximum-pool-size: 10       \n      minimum-idle: 5             \n      idle-timeout: 600000        \n      pool-name: hikari-pool\n\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.wzkris.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/*/*.xml\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n\n# 租户配置\ntenant:\n  includes:\n    - tenant_login_log\n    - tenant_operate_log\n\n# springdoc配置\nspringdoc:\n  title: 消息模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n', '075f70e57dcef691d8b2cc8ab0c2e80e', '2023-06-19 02:28:00', '2025-11-10 15:28:01', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (21, 'redis.yml', 'COMMON_GROUP', 'spring:\r\n  redis:\r\n    redisson: \r\n      config: |\r\n        # 单节点配置\r\n        singleServerConfig: \r\n          # redis 节点地址\r\n          address: \"redis://127.0.0.1:6379\"\r\n          # 无密码则设置 null\r\n          password: null\r\n          # 客户端名称\r\n          clientName: ${spring.application.name}\r\n          # 最小空闲连接数\r\n          connectionMinimumIdleSize: 32\r\n          # 连接池大小\r\n          connectionPoolSize: 64\r\n          # 连接空闲超时,单位:毫秒\r\n          idleConnectionTimeout: 10000\r\n          # 命令等待超时,单位:毫秒\r\n          timeout: 3000\r\n          # 发布和订阅连接池大小\r\n          subscriptionConnectionPoolSize: 50\r\n        # 线程池数量\r\n        threads: 8\r\n        # Netty线程池数量\r\n        nettyThreads: 8\r\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\r\n        transportMode: \"NIO\"\r\n', 'd19d9cfcd786295407bfb79f4365c633', '2025-08-04 15:12:22', '2025-10-27 10:53:39', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', 'redis公共配置', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (22, 'thread.yml', 'COMMON_GROUP', 'dynamic-threadpool:\n  executors:\n  - threadPoolName: t11\n    threadNamePrefix: AsyncThreadPool-\n    corePoolSize: 1\n    maximumPoolSize: 100\n    keepAliveTime: 60', '64449d32bf21e60ccff80cb2230d300d', '2025-08-11 09:55:20', '2025-12-02 15:01:51', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '动态线程池', '', '', 'yaml', '', '');
