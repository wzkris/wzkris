...
INSERT INTO `config_info` VALUES (13, 'wzkris-gateway.yml', 'APPLICATION_GROUP', 'spring:\n  cloud:\n    gateway:\n      server:\n        webflux:\n          httpclient:\n            connect-timeout: 5000\n            response-timeout: 5000\n            pool:\n              type: FIXED\n              max-connections: 1000\n              acquire-timeout: 80000\n              max-life-time: 30000\n              max-idle-time: 5000\n          discovery:\n            locator:\n              lower-case-service-id: true\n              enabled: true\n          default-filters: # 全局默认过滤器，对所有路由生效\n            - name: RequestSize\n              args:\n                maxSize: 5MB\n          routes:\n            # 认证中心\n            - id: wzkris-auth\n              uri: lb://wzkris-auth\n              predicates:\n                - Path=/auth/**\n              filters:\n                - StripPrefix=1\n              # 用户中心服务\n            - id: wzkris-user-center\n              uri: lb://wzkris-user-center\n              predicates:\n                - Path=/user-center/**\n              filters:\n                - StripPrefix=1\n            # 系统模块\n            - id: wzkris-system\n              uri: lb://wzkris-system\n              predicates:\n                - Path=/system/**\n              filters:\n                - StripPrefix=1\nknife4j:\n  # 聚合swagger文档\n  gateway:\n    enabled: true\n    strategy: discover\n    discover:\n      version: openapi3\n      enabled: true\n      service-config:\n        wzkris-auth:\n          - group-name: 认证服务\n            order: 1\n        wzkris-principal:\n          - group-name: 用户中心服务\n            order: 1\n        wzkris-message:\n          - group-name: 系统服务\n            order: 2\n    tags-sorter: order\n    operations-sorter: order\n\n# 防止XSS攻击\nxss:\n  enabled: true\n  excludeUrls:\n    - /system/announcement-manage/add\n    - /system/announcement-manage/edit\n\n# 网关放行\nsecurity:\n  ignores:\n    # 验证码放行\n    - /auth/captcha/**\n    # 登录接口\n    - /auth/login\n    # 登出接口\n    - /auth/logout\n    # oauth2接口\n    - /auth/oauth2/token\n    # 二维码登录\n    - /auth/qr-code\n    - /auth/qr-code/poll-status\n    # 回调接口\n    - /auth/authorization_code_callback\n    - /user-center/nacos/**\n    # swagger接口放行\n    - /doc.html\n    - /favicon.ico\n    - /webjars/**\n    - /v3/api-docs/**\n    - /*/v3/api-docs/**\n    # 监控端点\n    - /actuator/**', '32038a5714a3a2177e1b27b66eefd754', '2023-06-19 02:28:00', '2025-12-25 17:59:27', NULL, '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
