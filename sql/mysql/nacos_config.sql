...
INSERT INTO `config_info` VALUES (10, 'application-common.yml', 'APPLICATION_GROUP', 'server:\n  # 优雅停机\n  shutdown: graceful\n\nspring:\n  pid:\n    # 将 PID 写入文件中\n    file: ./${spring.application.name}.pid\n  jackson:\n    time-zone: GMT+8\n    # 日期格式化\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略空Bean转json的错误\n      FAIL_ON_EMPTY_BEANS: false\n      # 关闭日期转换成时间戳\n      WRITE_DATES_AS_TIMESTAMPS: false\n    # 设置空如何序列化\n    defaultPropertyInclusion: ALWAYS\n    deserialization:\n      #json中不存在的属性就报错\n      fail_on_unknown_properties: false\n    parser:\n      # 允许使用无引号字段\n      ALLOW_UNQUOTED_FIELD_NAMES: true\n      # 忽略未定义的属性\n      IGNORE_UNDEFINED: true\n      # 忽略json最后的逗号\n      ALLOW_TRAILING_COMMA: true\n      # 允许反斜杠\n      ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER: true\n      # 允许出现特殊字符和转义符\n      ALLOW_UNQUOTED_CONTROL_CHARS: true\n      # 允许出现单引号\n      ALLOW_SINGLE_QUOTES: true\n      # 是否允许使用注释\n      ALLOW_COMMENTS: true\n    mapper:\n      # 使用getter取代setter探测属性，如类中含getName()但不包含name属性与setName()，传输的vo json格式模板中依旧含name属性\n      USE_GETTERS_AS_SETTERS: true\n  mvc:\n    # mvc找不到对应处理器则抛出异常\n    throw-exception-if-no-handler-found: true\n    # 关闭DispatcherServlet懒加载\n    servlet:\n      load-on-startup: 0\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common\n\n#分布式事务\nseata:\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      ruoyi-system-group: default\n    # 分组和 Seata 服务的映射\n    grouplist:\n      default: 127.0.0.1:8091\n  config:\n    type: nacos\n    nacos:\n      serverAddr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      group: SEATA_GROUP\n      namespace: f06f7669-9836-4413-86cf-9f44ae5c9f30\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      namespace: f06f7669-9836-4413-86cf-9f44ae5c9f30\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"', '3b1491fd497faba5cbbbd6f13f49aafa', '2023-06-19 02:28:00', '2025-02-26 16:35:23', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '公共配置', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (11, 'wzkris-gateway.yml', 'APPLICATION_GROUP', 'spring:\n  cloud:\n    gateway:\n      httpclient:\n        pool:\n          type: FIXED\n          max-connections: 1000\n          acquire-timeout: 80000\n          max-life-time: 30000\n          max-idle-time: 5000\n          connect-timeout: 5000\n          response-timeout: 5000\n          max-request-size: 50MB\n      discovery:\n        locator:\n          lower-case-service-id: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: wzkris-auth\n          uri: lb://wzkris-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            - StripPrefix=1\n        # 用户服务\n        - id: wzkris-user\n          uri: lb://wzkris-user\n          predicates:\n            - Path=/ur_biz/**\n          filters:\n            - StripPrefix=1\n            # 黑名单过滤器\n            - name: BlackListUrlFilter\n              args:\n                blacklistUrl:\n                - /nacos/test\n        # 系统模块\n        - id: wzkris-system\n          uri: lb://wzkris-system\n          predicates:\n            - Path=/sys_biz/**\n          filters:\n            - StripPrefix=1\n        # 文件服务\n        - id: wzkris-file\n          uri: lb://wzkris-file\n          predicates:\n            - Path=/fl_biz/**\n          filters:\n            - StripPrefix=1\n        # 监控服务\n        - id: wzkris-monitor\n          uri: lb://wzkris-monitor\n          predicates:\n            - Path=/moniter/**\n          filters:\n            - StripPrefix=1\n\nknife4j:\n  # 聚合swagger文档\n  gateway:\n    enabled: true\n    strategy: discover\n    discover:\n      version: openapi3\n      enabled: true\n      service-config:\n        wzkris-auth:\n          - group-name: 认证服务\n            order: 1\n        wzkris-user:\n          - group-name: 用户服务\n            order: 1\n        wzkris-system:\n          - group-name: 系统服务\n            order: 2\n        wzkris-equipment:\n          - group-name: 设备服务\n            order: 4\n        wzkris-file:\n          - group-name: 文件服务\n            order: 5\n        wzkris-job:\n          - group-name: 定时任务服务\n            order: 6\n    tags-sorter: order\n    operations-sorter: order\n\n# 防止XSS攻击\nxss:\n  enabled: true\n  excludeUrls:\n    - /sys_biz/sys_message/add\n    - /sys_biz/sys_message/edit\n\n# 网关放行\nsecurity:\n  ignores:\n    # 验证码放行\n    - /auth/captcha/**\n    # 认证接口\n    - /auth/oauth2/**\n    # 回调接口\n    - /auth/authorization_code_callback\n    # 微信js接口\n    - /ur_biz/wx_req/js_ticket_sign\n    # 用户注册\n    - /ur_biz/app_register/*\n    # swagger接口放行\n    - /*/v3/api-docs/**\n    # 开放接口放行\n    - /*/open/**\n    # 上传图片可访问\n    - /fl_biz/uploadPath/**\n', 'bb95eeaf4f023438e5b2ce9bc2048254', '2023-06-19 02:28:00', '2025-02-26 16:40:12', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (12, 'wzkris-auth.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/auth\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\n# springdoc配置\nspringdoc:\n  title: 认证模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n  # 不校验白名单\n  ignores:\n    #spring监控服务放行\n    - /actuator/**\n    #swagger接口放行\n    - /v3/api-docs/**\n    # 登出\n    - /oauth/logout\n    # 验证码放行\n    - /captcha/**\n    - /authorization_code_callback\n\n# token配置\ntoken-config:\n  accessTokenTimeOut: 1800\n  refreshTokenTimeOut: 86400\n  authorizationCodeTimeOut: 1800\n  deviceCodeTimeOut: 1800\n', '494687af793a5bd3513e5aa7ca0dd631', '2023-06-19 02:28:00', '2025-03-08 10:30:40', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (13, 'wzkris-user.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/user\n  # datasource:\n  #   driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n  #   url: jdbc:shardingsphere:classpath:sharding-${spring.profiles.active}.yml\n  datasource:\n    url: jdbc:postgresql://localhost:5432/wzkris_user?ssl=false&reWriteBatchedInserts=true&stringtype=unspecified\n    username: root\n    password: root\n    driver-class-name: org.postgresql.Driver\n    hikari:\n      connection-timeout: 30000 \n      maximum-pool-size: 10       \n      minimum-idle: 5             \n      idle-timeout: 600000        \n      pool-name: hikari-pool\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.wzkris.user.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/user/*.xml\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n\n# springdoc配置\nspringdoc:\n  title: 用户模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 安全配置\nsecurity:\n  ignores:\n    #spring监控服务放行\n    - /actuator/**\n    #swagger接口放行\n    - /v3/api-docs/**\n    # js签名接口\n    - /wx_req/js_ticket_sign\n\n\n# 租户配置\ntenant:\n  includes:\n    - sys_dept\n    - sys_post\n    - sys_role\n    - sys_tenant\n    - sys_tenant_wallet\n    - sys_tenant_wallet_record\n    - sys_user', '53ac6dc854a8fea7165af70303e844f4', '2024-04-16 06:36:22', '2025-03-03 16:38:40', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (15, 'wzkris-system.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/system\n  # datasource:\n  #   driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n  #   url: jdbc:shardingsphere:classpath:sharding-${spring.profiles.active}.yml\n  datasource:\n    url: jdbc:postgresql://localhost:5432/wzkris_system?ssl=false&reWriteBatchedInserts=true&stringtype=unspecified\n    username: root\n    password: root\n    driver-class-name: org.postgresql.Driver\n    hikari:\n      connection-timeout: 30000 \n      maximum-pool-size: 10       \n      minimum-idle: 5             \n      idle-timeout: 600000        \n      pool-name: hikari-pool\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.wzkris.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/system/*.xml\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n\n# 安全配置\nsecurity:\n  ignores:\n    #spring监控服务放行\n    - /actuator/**\n    #swagger接口放行\n    - /v3/api-docs/**\n\n# 租户配置\ntenant:\n  includes:\n    - sys_login_log\n    - sys_oper_log\n\n# springdoc配置\nspringdoc:\n  title: 系统模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n', 'a19bcde9971d747983ff946d1e3abda8', '2023-06-19 02:28:00', '2025-03-03 16:38:46', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
