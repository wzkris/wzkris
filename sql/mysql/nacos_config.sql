...
INSERT INTO `config_info` VALUES (11, 'wzkris-gateway.yml', 'APPLICATION_GROUP', 'spring:\n  cloud:\n    gateway:\n      httpclient:\n        pool:\n          type: FIXED\n          max-connections: 1000\n          acquire-timeout: 80000\n          max-life-time: 30000\n          max-idle-time: 5000\n          connect-timeout: 5000\n          response-timeout: 5000\n          max-request-size: 50MB\n      discovery:\n        locator:\n          lower-case-service-id: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: wzkris-auth\n          uri: lb://wzkris-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            - StripPrefix=1\n        # 用户服务\n        - id: wzkris-user\n          uri: lb://wzkris-user\n          predicates:\n            - Path=/ur_biz/**\n          filters:\n            - StripPrefix=1\n            # 黑名单过滤器\n            - name: BlackListUrlFilter\n              args:\n                blacklistUrl:\n                - /nacos/test\n        # 系统模块\n        - id: wzkris-system\n          uri: lb://wzkris-system\n          predicates:\n            - Path=/sys_biz/**\n          filters:\n            - StripPrefix=1\n        # 文件服务\n        - id: wzkris-file\n          uri: lb://wzkris-file\n          predicates:\n            - Path=/fl_biz/**\n          filters:\n            - StripPrefix=1\n        # 监控服务\n        - id: wzkris-monitor\n          uri: lb://wzkris-monitor\n          predicates:\n            - Path=/moniter/**\n          filters:\n            - StripPrefix=1\n\nknife4j:\n  # 聚合swagger文档\n  gateway:\n    enabled: true\n    strategy: discover\n    discover:\n      version: openapi3\n      enabled: true\n      service-config:\n        wzkris-auth:\n          - group-name: 认证服务\n            order: 1\n        wzkris-user:\n          - group-name: 用户服务\n            order: 1\n        wzkris-system:\n          - group-name: 系统服务\n            order: 2\n        wzkris-equipment:\n          - group-name: 设备服务\n            order: 4\n        wzkris-file:\n          - group-name: 文件服务\n            order: 5\n        wzkris-job:\n          - group-name: 定时任务服务\n            order: 6\n    tags-sorter: order\n    operations-sorter: order\n\n# 防止XSS攻击\nxss:\n  enabled: true\n  excludeUrls:\n    - /sys_biz/sys_message/add\n    - /sys_biz/sys_message/edit\n\n# 网关放行\nsecurity:\n  ignores:\n    # 验证码放行\n    - /auth/captcha/**\n    # 认证接口\n    - /auth/oauth2/**\n    # 回调接口\n    - /auth/authorization_code_callback\n    # 微信js接口\n    - /ur_biz/wx_req/js_ticket_sign\n    # 用户注册\n    - /ur_biz/app_register/*\n    # swagger接口放行\n    - /*/v3/api-docs/**\n    # 开放接口放行\n    - /*/open/**\n    # 上传图片可访问\n    - /fl_biz/uploadPath/**\n', 'bb95eeaf4f023438e5b2ce9bc2048254', '2023-06-19 02:28:00', '2025-03-08 13:12:38', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (12, 'wzkris-auth.yml', 'APPLICATION_GROUP', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/auth\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\n# springdoc配置\nspringdoc:\n  title: 认证模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 安全配置\nsecurity:\n  # 不校验白名单\n  ignores:\n    #spring监控服务放行\n    - /actuator/**\n    #swagger接口放行\n    - /v3/api-docs/**\n    # 验证码放行\n    - /captcha/**\n    - /authorization_code_callback\n\n# token配置\ntoken-config:\n  accessTokenTimeOut: 1800\n  refreshTokenTimeOut: 86400\n  authorizationCodeTimeOut: 1800\n  deviceCodeTimeOut: 1800\n', '0a7976e86cf42d4d7a905033d634d2fe', '2023-06-19 02:28:00', '2025-03-21 09:28:26', 'nacos', '0:0:0:0:0:0:0:1', '', 'application-dev', '', '', '', 'yaml', '', '');
