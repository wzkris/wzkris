...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1877963169153585154, 0, '系统用户', '修改用户', '2', 'com.wzkris.user.controller.SysUserController.edit()', 'POST', 1, 'admin', '/sys_user/edit', '127.0.0.1', '内网IP', '{\"roleIds\":[2],\"gender\":\"0\",\"postIds\":[1],\"deptId\":100,\"nickname\":\"nick_kris\",\"userId\":2,\"email\":\"111111@1.com\",\"username\":\"wzkris\",\"status\":\"0\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736576284910}', '0', NULL, 1736576284910);
...
INSERT INTO `sys_oper_log` VALUES (1878997168202334210, 0, '系统用户', '重置密码', '2', 'com.wzkris.user.controller.SysUserController.resetPwd()', 'POST', 1, 'admin', '/sys_user/reset_password', '127.0.0.1', '内网IP', '{\"password\":\"**\",\"id\":1856251200466030593}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736822809630}', '0', NULL, 1736822809630);
INSERT INTO `sys_oper_log` VALUES (1879034323901497346, 0, '系统用户', '修改用户', '2', 'com.wzkris.user.controller.SysUserController.edit()', 'POST', 1, 'admin', '/sys_user/edit', '127.0.0.1', '内网IP', '{\"roleIds\":[1775445330027577345],\"gender\":\"2\",\"postIds\":[],\"deptId\":1775382319191453698,\"nickname\":\"xxxxxx\",\"userId\":1856251200466030593,\"username\":\"___sub_\",\"status\":\"0\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736831668211}', '0', NULL, 1736831668211);
...
INSERT INTO `sys_oper_log` VALUES (1879065533864361985, 0, '系统用户', '新增用户', '1', 'com.wzkris.user.controller.SysUserController.add()', 'POST', 1, 'admin', '/sys_user/add', '127.0.0.1', '内网IP', '{\"roleIds\":[],\"postIds\":[],\"username\":\"aaaaaa\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736839109236}', '0', NULL, 1736839109237);
...
INSERT INTO `sys_oper_log` VALUES (1879068982572105730, 0, '系统用户', '状态修改', '2', 'com.wzkris.user.controller.SysUserController.editStatus()', 'POST', 1, 'admin', '/sys_user/edit_status', '127.0.0.1', '内网IP', '{\"id\":1879065533604380673,\"status\":\"1\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736839931499}', '0', NULL, 1736839931499);
INSERT INTO `sys_oper_log` VALUES (1879069852865019905, 0, '系统用户', '状态修改', '2', 'com.wzkris.user.controller.SysUserController.editStatus()', 'POST', 1, 'admin', '/sys_user/edit_status', '127.0.0.1', '内网IP', '{\"id\":1879065533604380673,\"status\":\"0\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736840139009}', '0', NULL, 1736840139009);
...
INSERT INTO `sys_oper_log` VALUES (1879080054771302401, 1774671331416821762, '商户信息', '修改操作密码', '2', 'com.wzkris.user.controller.SysTenantOwnController.editOperPwd()', 'POST', 1774671331412627456, 'testtt', '/tenant/edit_operpwd', '127.0.0.1', '内网IP', '{\"oldPassword\":\"**\",\"newPassword\":\"**\"}', '{\"code\":1,\"message\":\"修改密码失败，旧密码错误\",\"timestamp\":1736842571270}', '1', '修改密码失败，旧密码错误', 1736842571277);
INSERT INTO `sys_oper_log` VALUES (1879080076506185730, 1774671331416821762, '商户信息', '修改操作密码', '2', 'com.wzkris.user.controller.SysTenantOwnController.editOperPwd()', 'POST', 1774671331412627456, 'testtt', '/tenant/edit_operpwd', '127.0.0.1', '内网IP', '{\"oldPassword\":\"**\",\"newPassword\":\"**\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736842576515}', '0', NULL, 1736842576515);
INSERT INTO `sys_oper_log` VALUES (1879080317959684097, 1774671331416821762, '系统用户', '删除用户', '3', 'com.wzkris.user.controller.SysUserController.remove()', 'POST', 1774671331412627456, 'testtt', '/sys_user/remove', '127.0.0.1', '内网IP', '[1856869914760638466]', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736842634082}', '0', NULL, 1736842634082);
INSERT INTO `sys_oper_log` VALUES (1879080410657996801, 1774671331416821762, '系统用户', '重置密码', '2', 'com.wzkris.user.controller.SysUserController.resetPwd()', 'POST', 1774671331412627456, 'testtt', '/sys_user/reset_password', '127.0.0.1', '内网IP', '{\"password\":\"**\",\"id\":1774671331412627456}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736842656183}', '0', NULL, 1736842656183);
INSERT INTO `sys_oper_log` VALUES (1879339960753623041, 1774671331416821762, '系统用户', '修改用户', '2', 'com.wzkris.user.controller.SysUserController.edit()', 'POST', 1774671331412627456, 'testtt', '/sys_user/edit', '127.0.0.1', '内网IP', '{\"roleIds\":[1775445330027577345],\"gender\":\"2\",\"postIds\":[],\"deptId\":1775382319191453698,\"nickname\":\"xxxxxx\",\"userId\":1856251200466030593,\"username\":\"___sub_\",\"status\":\"0\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736904537669}', '0', NULL, 1736904537669);
INSERT INTO `sys_oper_log` VALUES (1879343474041065473, 1774671331416821762, '系统用户', '新增用户', '1', 'com.wzkris.user.controller.SysUserController.add()', 'POST', 1774671331412627456, 'testtt', '/sys_user/add', '127.0.0.1', '内网IP', '{\"deptId\":1775387364419072002,\"username\":\"xxxxxx\"}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736905375350}', '0', NULL, 1736905375352);
INSERT INTO `sys_oper_log` VALUES (1879343575140569090, 1774671331416821762, '系统用户', '重置密码', '2', 'com.wzkris.user.controller.SysUserController.resetPwd()', 'POST', 1774671331412627456, 'testtt', '/sys_user/reset_password', '127.0.0.1', '内网IP', '{\"password\":\"**\",\"id\":1856251200466030593}', '{\"code\":0,\"message\":\"Success\",\"timestamp\":1736905399480}', '0', NULL, 1736905399480);
...
INSERT INTO `sys_oper_log` VALUES (1879349193607909377, 0, '系统用户', '状态修改', '2', 'com.wzkris.user.controller.SysRoleController.editStatus()', 'POST', 2, 'wzkris', '/sys_role/edit_status', '127.0.0.1', '内网IP', '{\"id\":4,\"status\":\"0\"}', NULL, '1', '无此角色数据访问权限', 1736906738979);
INSERT INTO `sys_oper_log` VALUES (1879350263432253442, 0, '系统用户', '状态修改', '2', 'com.wzkris.user.controller.SysRoleController.editStatus()', 'POST', 2, 'wzkris', '/sys_role/edit_status', '127.0.0.1', '内网IP', '{\"id\":4,\"status\":\"0\"}', NULL, '1', '无此角色数据访问权限', 1736906994094);
