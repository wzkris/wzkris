...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, 0, '0', '最高部门', '0', 0, '15888888888', '', 1713334134616, 1, 1742518945472, 1);
INSERT INTO `sys_dept` VALUES (105, 0, 114, '0,100,1858433026613760002,114', 'jeecg集团', '1', 3, '15888888888', 'jeecg@qq.com', 1713334134616, 1, 1742519232680, 1);
INSERT INTO `sys_dept` VALUES (114, 0, 100, '0,100', 'pig开源联盟', '1', 0, NULL, NULL, 1713334134616, 1, 1742519232680, 1);
...
INSERT INTO `sys_menu` VALUES (203, '系统用户', 2, 100, 'sysuser', 'user/sysuser/index', NULL, 'M', '0', 'sys_user:list', 'user', 0, 1, 1, 1713334134616, 1, 1737513387243, 1);
...
INSERT INTO `sys_menu` VALUES (1062, '操作日志敏感字段', 150, 10, '#', NULL, NULL, 'F', '0', 'operlog:field', '#', 0, 0, 1, 1738049149110, 1, 1738049213288, 1);
...
INSERT INTO `sys_menu` VALUES (3231, '设备敏感字段', 3228, 10, '#', NULL, NULL, 'F', '0', 'device:field', '#', 0, 0, 1, 1734503404422, 1, 1738049195821, 1);
...
INSERT INTO `sys_tenant_package` VALUES (1773625804122202113, '默认套餐', '0', '[1, 2, 3, 601, 4, 401, 104, 151, 1064, 150, 203, 2078, 2062, 2064, 2077, 2072, 2071, 206, 2207, 2211, 2210, 2209, 2208, 205, 2040, 2039, 2038, 2037, 208, 2145, 2144, 2143, 2142, 2141, 1125, 1126, 1127, 3228, 3226, 400, 3126, 3125, 3124, 3123, 3122, 3121]', 0, '通用租户套餐', 1, 1713334134616, 1, 1738049250477);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 0, 100, 'admin', 'xxxxx@163.com', 'nick_admin', '15888888888', '0', '1', NULL, '{bcrypt}$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0:0:0:0:0:0:0:1', 1742517926259, NULL, 1713334134616, 1, NULL, NULL);
INSERT INTO `sys_user` VALUES (2, 0, 105, 'wzkris', '111111@1.com', 'nick_kris', NULL, '0', '0', NULL, '{bcrypt}$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '127.0.0.1', 1731992153861, NULL, 1713334134616, 1, 1742519263711, 1);
...
-- ----------------------------
-- Table structure for sys_withdrawal_record
-- ----------------------------
DROP TABLE IF EXISTS `sys_withdrawal_record`;
CREATE TABLE `sys_withdrawal_record`  (
  `withdrawal_id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单号',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '状态\r\n\'0\' 处理中\r\n\'1\' 成功\r\n\'2\' 失败',
  `tenant_id` bigint NOT NULL COMMENT '租户id',
  `request_params` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '第三方请求参数',
  `amount` decimal(10, 2) UNSIGNED NOT NULL COMMENT '金额',
