/*
 ...
 Source Host           : 101.37.163.107:3306
...
INSERT INTO `config_info` VALUES (17, 'wzkris-equipment.yml', 'wzkris', '# spring配置\nspring:\n  # datasource:\n  #   driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n  #   url: jdbc:shardingsphere:classpath:sharding-${spring.profiles.active}.yml\n  datasource:\n    url: jdbc:mysql://localhost:3306/wzkris_equipment?rewriteBatchedStatements=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=Asia/Shanghai\n    username: root\n    password: root\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    hikari:\n      connection-timeout: 30000 \n      maximum-pool-size: 10       \n      minimum-idle: 5             \n      idle-timeout: 600000        \n      pool-name: hikari-pool\n  redis:\n    redisson: \n      config: |\n        # 单节点配置\n        singleServerConfig: \n          # redis 节点地址\n          address: \"redis://127.0.0.1:6379\"\n          # 无密码则设置 null\n          password: null\n          # 客户端名称\n          clientName: ${spring.application.name}\n          # 最小空闲连接数\n          connectionMinimumIdleSize: 32\n          # 连接池大小\n          connectionPoolSize: 64\n          # 连接空闲超时,单位:毫秒\n          idleConnectionTimeout: 10000\n          # 命令等待超时,单位:毫秒\n          timeout: 3000\n          # 发布和订阅连接池大小\n          subscriptionConnectionPoolSize: 50\n        # 线程池数量\n        threads: 2\n        # Netty线程池数量\n        nettyThreads: 8\n        codec: !<org.redisson.codec.JsonJacksonCodec> {}\n        transportMode: \"NIO\"\n\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.wzkris.**.domain\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/equipment/*.xml\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n\n#mqtt基本配置\nmqtt:\n  enable: false\n  settings: \n    car:\n      clientNum: 3\n      host: tcp://127.0.0.1:1883\n      userName: server_prod\n      password: ${server.port}\n      clientId: server_prod\n      automaticReconnect: true\n      maxReconnectDelay: 60000\n      cleanSession: false\n      maxInFlight: 1000\n      connectTimeout: 15\n      keepAlive: 180\n    example:\n      clientNum: 2\n      host: tcp://127.0.0.1:1883\n      userName: server_prod\n      password: ${server.port}\n      clientId: server_prod\n      automaticReconnect: true\n      maxReconnectDelay: 60000\n      cleanSession: true\n      maxInFlight: 100\n      connectTimeout: 15\n      keepAlive: 10\n\n# 不校验白名单\nsecurity:\n  white:\n    custom:\n      urls:\n        # mqtt验证接口\n        - /emqx/authorize\n\n# springdoc配置\nspringdoc:\n  title: 设备模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n', 'cd723fab72169d2084682af1fcd8fc5c', '2023-06-19 02:28:00', '2024-11-27 01:47:55', 'nacos', '0:0:0:0:0:0:0:1', '', 'wzkris-dev', '', '', '', 'yaml', '', '');
