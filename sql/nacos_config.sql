...
INSERT INTO `config_info` VALUES (10, 'application-common.yml', 'thingslink', 'server:\n  # 优雅停机\n  shutdown: graceful\n\nspring:\n  pid:\n    # 将 PID 写入文件中\n    file: ./${spring.application.name}.pid\n  jackson:\n    time-zone: GMT+8\n    # 日期格式化\n    date-format: yyyy-MM-dd HH:mm:ss\n    serialization:\n      # 格式化输出\n      INDENT_OUTPUT: false\n      # 忽略空Bean转json的错误\n      FAIL_ON_EMPTY_BEANS: false\n      # 关闭日期转换成时间戳\n      WRITE_DATES_AS_TIMESTAMPS: false\n    # 设置空如何序列化\n    defaultPropertyInclusion: ALWAYS\n    deserialization:\n      #json中不存在的属性就报错\n      fail_on_unknown_properties: false\n    parser:\n      # 允许使用无引号字段\n      ALLOW_UNQUOTED_FIELD_NAMES: true\n      # 忽略未定义的属性\n      IGNORE_UNDEFINED: true\n      # 忽略json最后的逗号\n      ALLOW_TRAILING_COMMA: true\n      # 允许反斜杠\n      ALLOW_BACKSLASH_ESCAPING_ANY_CHARACTER: true\n      # 允许出现特殊字符和转义符\n      ALLOW_UNQUOTED_CONTROL_CHARS: true\n      # 允许出现单引号\n      ALLOW_SINGLE_QUOTES: true\n      # 是否允许使用注释\n      ALLOW_COMMENTS: true\n    mapper:\n      # 使用getter取代setter探测属性，如类中含getName()但不包含name属性与setName()，传输的vo json格式模板中依旧含name属性\n      USE_GETTERS_AS_SETTERS: true\n  mvc:\n    # mvc找不到对应处理器则抛出异常\n    throw-exception-if-no-handler-found: true\n    # 关闭DispatcherServlet懒加载\n    servlet:\n      load-on-startup: 0\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common\n  cloud:\n    openfeign:\n      # 请求使用okhttp\n      okhttp:\n        enabled: true\n      # openfeign超时配置\n      client:\n        config:\n          default:\n            connectTimeout: 10000\n            readTimeout: 10000\n            loggerLevel: basic\n\n# feign启用sentinel\nfeign:\n  sentinel:\n    enabled: true\n\n#分布式事务\nseata:\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      ruoyi-system-group: default\n    # 分组和 Seata 服务的映射\n    grouplist:\n      default: 127.0.0.1:8091\n  config:\n    type: nacos\n    nacos:\n      serverAddr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      group: SEATA_GROUP\n      namespace: f06f7669-9836-4413-86cf-9f44ae5c9f30\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: ${spring.cloud.nacos.server-addr}\n      username: ${spring.cloud.nacos.username}\n      password: ${spring.cloud.nacos.password}\n      namespace: f06f7669-9836-4413-86cf-9f44ae5c9f30\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n\n# 不校验白名单\nsecurity:\n  introspectionUri: http://127.0.0.1:8080/auth/oauth2/check_token\n  identityKey: 8edeb038-38e7-11ef-9ec3-00155d106729\n  identityValue: aa2160ee-38e7-11ef-817b-fa163ecd525d\n  white:\n    commonUrls:\n      #内部接口\n      - /inner/**\n      #spring监控服务放行\n      - /actuator/**\n      #swagger接口放行\n      - /v3/api-docs/**\n      - /webjars/**\n      #开放接口放行\n      - /open/**\n      #上传图片可访问\n      - /uploadPath/**\n      #异常处理\n      - /error', '84e2cef7fd8f77184c77c6dd0410d0cc', '2023-06-19 02:28:00', '2024-07-03 05:37:04', 'nacos', '0:0:0:0:0:0:0:1', '', 'dev', '公共配置', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (12, 'thingslink-auth.yml', 'thingslink', '# spring配置\nspring:\n  messages:\n    # 国际化资源文件路径\n    basename: i18n/common,i18n/auth\n\nredisson:\n  # 线程池数量\n  threads: 16\n  # Netty线程池数量\n  nettyThreads: 32\n  # 单节点配置\n  singleServerConfig:\n    # redis 节点地址\n    address: \"redis://127.0.0.1:6379\"\n    # 无密码则设置 null\n    password: \'\'\n    # 客户端名称\n    clientName: ${spring.application.name}\n    # 最小空闲连接数\n    connectionMinimumIdleSize: 32\n    # 连接池大小\n    connectionPoolSize: 64\n    # 连接空闲超时,单位:毫秒\n    idleConnectionTimeout: 10000\n    # 命令等待超时,单位:毫秒\n    timeout: 3000\n    # 发布和订阅连接池大小\n    subscriptionConnectionPoolSize: 50\n\n# springdoc配置\nspringdoc:\n  title: 认证模块接口文档\n  license: Powered By wzkris\n  version: v1.0.0\n  description: ---\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: false\n    type: math\n  # 不校验白名单\n  white:\n    customUrls:\n      # token校验接口放行\n      - /oauth2/check_token\n      # 验证码放行\n      - /code\n      - /sms_code\n\n# token配置\ntoken-config:\n  accessTokenTimeOut: 1800\n  refreshTokenTimeOut: 86400\n  authorizationCodeTimeOut: 180\n  deviceCodeTimeOut: 180\n', '911c4d2e78b883bafb0dfd3008bbff77', '2023-06-19 02:28:00', '2024-07-03 06:58:55', 'nacos', '0:0:0:0:0:0:0:1', '', 'dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (14, 'thingslink-monitor-admin.yml', 'thingslink', '# spring\nspring:\n  security:\n    user:\n      name: admin\n      password: admin123\n  boot:\n    admin:\n      ui:\n        title: 服务状态监控\n', 'dd19c14e3cebc473140e1fc8733a339d', '2023-06-19 02:28:00', '2024-07-03 05:51:40', 'nacos', '0:0:0:0:0:0:0:1', '', 'dev', '', '', '', 'yaml', '', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;
