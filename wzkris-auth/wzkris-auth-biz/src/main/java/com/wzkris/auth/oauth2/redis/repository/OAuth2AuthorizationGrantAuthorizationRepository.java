 ...
 */
package com.wzkris.auth.oauth2.redis.repository;

import com.wzkris.auth.oauth2.redis.entity.OAuth2AuthorizationGrantAuthorization;
import com.wzkris.auth.oauth2.redis.entity.model.OAuth2AuthorizationCodeGrantAuthorization;
import com.wzkris.auth.oauth2.redis.entity.model.OAuth2DeviceCodeGrantAuthorization;
import com.wzkris.auth.oauth2.redis.entity.model.OidcAuthorizationCodeGrantAuthorization;
