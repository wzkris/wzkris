...
final class ModelMapper {
    ...
    static OAuth2PasswordGrantAuthorization convertOAuth2PasswordGrantAuthorization(
            OAuth2Authorization authorization) {
    ...
    static OAuth2SmsGrantAuthorization convertOAuth2SmsGrantAuthorization(
            OAuth2Authorization authorization) {

        OAuth2AuthorizationGrantAuthorization.AccessToken accessToken = extractAccessToken(authorization);
        OAuth2AuthorizationGrantAuthorization.RefreshToken refreshToken = extractRefreshToken(authorization);

        return new OAuth2SmsGrantAuthorization(authorization.getId(), authorization.getRegisteredClientId(),
                authorization.getPrincipalName(), authorization.getAuthorizedScopes(), accessToken, refreshToken,
                authorization.getAttribute(Principal.class.getName()));
    }
    ...
    static void mapOAuth2PasswordGrantAuthorization(
            OAuth2PasswordGrantAuthorization authorizationGrant,
            OAuth2Authorization.Builder builder) {
    ...
    static void mapOAuth2SmsGrantAuthorization(
            OAuth2SmsGrantAuthorization authorizationGrant,
            OAuth2Authorization.Builder builder) {
        builder.id(authorizationGrant.getId())
                .principalName(authorizationGrant.getPrincipalName())
