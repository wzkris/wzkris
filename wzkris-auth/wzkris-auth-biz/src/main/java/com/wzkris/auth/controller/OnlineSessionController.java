...
import com.wzkris.auth.security.oauth2.redis.repository.OAuth2AuthorizationGrantAuthorizationRepository;
...
public class OnlineSessionController extends BaseController {
    ...
    public Result<Collection<OnlineUser>> onlineSession() {
        RMapCache<String, OnlineUser> onlineCache = OnlineUserUtil.getOnlineCache(SystemUserUtil.getUserId());
