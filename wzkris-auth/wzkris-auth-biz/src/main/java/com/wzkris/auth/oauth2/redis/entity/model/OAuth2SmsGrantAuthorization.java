...
@Getter
public class OAuth2SmsGrantAuthorization extends OAuth2AuthorizationGrantAuthorization {

    private final Principal principal;

    // @fold:on
    public OAuth2SmsGrantAuthorization(String id, String registeredClientId, String principalName,
