 ...
 * @version : V1.0.0
 * @description : 停止充电动作
 * @date : 2023/12/4 12:37
 */
@Component
public class StopChargeAction implements Action<ChargingStatus, ChargingEvent> {
    @Autowired
    ...
    public void execute(StateContext<ChargingStatus, ChargingEvent> context) {
        ...
        order.setChargingStatus(ChargingStatus.CHARGE_END.name());
