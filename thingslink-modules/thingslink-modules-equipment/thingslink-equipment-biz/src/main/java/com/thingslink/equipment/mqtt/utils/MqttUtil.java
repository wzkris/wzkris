...
import com.thingslink.equipment.mqtt.config.MqttProperties;
...
public class MqttUtil {
    ...
    public static void init() {
        ...
        try {
            ...
            // 订阅队列 加号为占位符
            mqttClient.subscribe(String.format(MqttTopic.CAR_AUTH, "+", "+"));
            mqttClient.subscribe(String.format(MqttTopic.CAR_ATTR, "+", "+"));
            mqttClient.subscribe(String.format(MqttTopic.CAR_SERVICE_REPLY, "+", "+"));
            mqttClient.subscribe(String.format(MqttTopic.CAR_EVENT, "+", "+"));
            mqttClient.subscribe("$SYS/brokers/+/clients/+/+");
        }
