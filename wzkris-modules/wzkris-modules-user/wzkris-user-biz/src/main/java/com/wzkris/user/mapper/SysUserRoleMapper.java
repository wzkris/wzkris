...
public interface SysUserRoleMapper {
     ...
     * @return 用户ID集合
     */
    @Select("SELECT user_id FROM biz.sys_user_role WHERE role_id = #{roleId}")
     ...
     * @return 用户ID集合
     */
    @Select("SELECT role_id FROM biz.sys_user_role WHERE user_id = #{userId}")
     ...
     * @return 结果
     */
    @Delete("DELETE FROM biz.sys_user_role WHERE user_id = #{userId}")
     ...
     * @return 结果
     */
    @Delete("DELETE FROM biz.sys_user_role WHERE user_id = #{userId} AND role_id = #{roleId}")
