...
import com.wzkris.user.domain.req.TenantManageQueryReq;
import com.wzkris.user.domain.req.TenantManageReq;
...
public class TenantManageController extends BaseController {
    ...
    public Result<Page<TenantInfoManageVO>> listPage(TenantManageQueryReq queryReq) {
        startPage();
        List<TenantInfoManageVO> list = tenantInfoMapper.selectVOList(this.buildQueryWrapper(queryReq));
