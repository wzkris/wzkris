package com.wzkris.principal.controller.oauth2;
...
import com.wzkris.principal.domain.export.oauth2.OAuth2ClientExport;
import com.wzkris.principal.domain.req.EditStatusReq;
import com.wzkris.principal.domain.req.oauth2.EditClientSecretReq;
import com.wzkris.principal.domain.req.oauth2.OAuth2ClientManageQueryReq;
import com.wzkris.principal.domain.req.oauth2.OAuth2ClientManageReq;
...
public class OAuth2ClientManageController extends BaseController {
    ...
    @GetMapping("/list")
    @CheckUserPerms("prin-mod:oauth2client-mng:list")
    ...
    @GetMapping("/{id}")
    @CheckUserPerms("prin-mod:oauth2client-mng:query")
    ...
    @PostMapping("/edit")
    @CheckUserPerms("prin-mod:oauth2client-mng:edit")
    ...
    @CheckUserPerms("prin-mod:oauth2client-mng:edit-secret")
    ...
    @PostMapping("/add")
    @CheckUserPerms("prin-mod:oauth2client-mng:add")
    ...
    @PostMapping("/remove")
    @CheckUserPerms("prin-mod:oauth2client-mng:remove")
    ...
    @GetMapping("/export")
    @CheckUserPerms("prin-mod:oauth2client-mng:export")
