...
import com.wzkris.principal.domain.req.role.RoleMngQueryReq;
import com.wzkris.principal.domain.req.role.RoleMngReq;
import com.wzkris.principal.domain.req.role.RoleToAdminsReq;
...
public class RoleMngController extends BaseController {
    ...
    @GetMapping("/{roleId}")
    @CheckAdminPerms("prin-mod:role-mng:query")
