package com.wzkris.principal.controller.dept;
...
import com.wzkris.principal.domain.req.dept.DeptMngReq;
...
public class DeptMngController extends BaseController {
    ...
    @GetMapping("/list")
    @CheckAdminPerms("prin-mod:dept-mng:list")
    ...
    @GetMapping("/{deptId}")
    @CheckAdminPerms("prin-mod:dept-mng:query")
