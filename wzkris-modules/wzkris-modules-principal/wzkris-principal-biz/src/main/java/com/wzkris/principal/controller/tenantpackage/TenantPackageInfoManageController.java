...
import com.wzkris.principal.domain.req.tenantpackage.TenantPackageManageQueryReq;
import com.wzkris.principal.domain.req.tenantpackage.TenantPackageManageReq;
...
public class TenantPackageInfoManageController extends BaseController {
    ...
    @GetMapping("/list")
    @CheckUserPerms("prin-mod:tenantpackage-mng:list")
    ...
    @PostMapping("/add")
    @CheckUserPerms("prin-mod:tenantpackage-mng:add")
    ...
    @PostMapping("/edit")
    @CheckUserPerms("prin-mod:tenantpackage-mng:edit")
    ...
    @PostMapping("/remove")
    @CheckUserPerms("prin-mod:tenantpackage-mng:remove")
