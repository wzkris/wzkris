package com.wzkris.principal.controller.role;
...
import com.wzkris.principal.manager.RoleInfoDataScopeManager;
import com.wzkris.principal.manager.UserInfoDataScopeManager;
...
public class RoleManageController extends BaseController {
    ...
    @GetMapping("/list")
    @CheckUserPerms("prin-mod:role-mng:list")
    ...
    @GetMapping("/{roleId}")
    @CheckUserPerms("prin-mod:role-mng:query")
    ...
    @CheckUserPerms(
            value = {"prin-mod:role-mng:edit", "prin-mod:role-mng:add"},
            mode = CheckMode.OR)
    ...
    @PostMapping("/add")
    @CheckUserPerms("prin-mod:role-mng:add")
    ...
    @PostMapping("/edit")
    @CheckUserPerms("prin-mod:role-mng:edit")
    ...
    @PostMapping("/remove")
    @CheckUserPerms("prin-mod:role-mng:remove")
