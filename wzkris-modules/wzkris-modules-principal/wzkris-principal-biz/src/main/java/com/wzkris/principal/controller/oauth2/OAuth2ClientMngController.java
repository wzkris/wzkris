...
import com.wzkris.principal.domain.req.oauth2.OAuth2ClientMngQueryReq;
import com.wzkris.principal.domain.req.oauth2.OAuth2ClientMngReq;
...
public class OAuth2ClientMngController extends BaseController {
    ...
    @GetMapping("/{id}")
    @CheckAdminPerms("prin-mod:oauth2client-mng:query")
