package com.wzkris.principal.controller.post;
...
import com.wzkris.principal.domain.req.post.PostManageQueryReq;
import com.wzkris.principal.domain.req.post.PostManageReq;
...
public class PostInfoManageController extends BaseController {
    ...
    private LambdaQueryWrapper<PostInfoDO> buildQueryWrapper(PostManageQueryReq queryReq) {
