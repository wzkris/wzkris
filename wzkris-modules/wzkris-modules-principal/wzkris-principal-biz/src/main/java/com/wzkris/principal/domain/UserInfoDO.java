...
import com.wzkris.principal.feign.userinfo.resp.UserInfoResp;
 ...
 */
@Data
@AutoMappers({@AutoMapper(target = UserInfoResp.class)})
@NoArgsConstructor
@TableName(schema = "biz", value = "user_info")
