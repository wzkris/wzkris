...
public class ProtocolController extends BaseController {
    ...
    @CheckPerms(value = {"product:add", "product:edit"}, mode = CheckPerms.Mode.OR)// 产品添加修改时使用
