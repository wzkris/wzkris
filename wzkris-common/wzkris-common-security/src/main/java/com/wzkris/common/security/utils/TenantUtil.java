...
public class TenantUtil extends SecurityUtil {

    /**
     * 是否登录
     */
    public static boolean isLogin() {
        return isAuthenticated() && getAuthType().equals(AuthType.TENANT);
    }
     ...
     * @return 当前用户
     */
    public static LoginTenant get() {
        try {
            return (LoginTenant) getPrincipal();
        } catch (Exception e) {
