...
public class DingtalkConfiguration {
     ...
     */
    @Bean
    public DingtalkMsgClient dingtalkApiClient(DingtalkProperties dingtalkProperties) {
        ...
        return new DingtalkMsgClient(dingtalkProperties);
    }
     ...
     */
    @Bean
    public DingtalkNotifier dingtalkNotifier(DingtalkMsgClient msgClient) {
        return new DingtalkNotifier(msgClient);
    }
