...
import com.thingslink.auth.mapper.SysTenantMapper;
import com.thingslink.auth.service.SysTenantService;
...
public class SysTenantController extends BaseController {
    ...
    @OperateLog(title = "租户", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @OperateLog(title = "租户", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @OperateLog(title = "租户", businessType = BusinessType.DELETE)
