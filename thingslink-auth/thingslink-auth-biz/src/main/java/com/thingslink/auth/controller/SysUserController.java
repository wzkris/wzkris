...
import com.thingslink.auth.mapper.SysUserPostMapper;
...
public class SysUserController extends BaseController {
    ...
    @OperateLog(title = "后台管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @OperateLog(title = "后台管理", businessType = BusinessType.DELETE)
    ...
    @OperateLog(title = "后台管理", businessType = BusinessType.GRANT)
    @PutMapping("/authRole")
    @PreAuthorize("hasAuthority('user:edit')")
