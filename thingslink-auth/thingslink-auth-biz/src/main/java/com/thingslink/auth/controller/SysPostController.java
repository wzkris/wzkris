...
import com.thingslink.auth.mapper.SysPostMapper;
...
public class SysPostController extends BaseController {
    ...
    @OperateLog(title = "岗位管理", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @OperateLog(title = "岗位管理", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Operation(summary = "修改岗位")
    @OperateLog(title = "岗位管理", businessType = BusinessType.DELETE)
